...
> [Siguiente](./2.%20How_do_transformers_work.md)

Un pipeline permite conectar un modelo con pasos de pre y post procesado de forma que nos permite introducir texto directamente y recibir una respuesta inteligible o coherente.
...
```
    Result: [{'label': 'POSITIVE', 'score': 0.9598047137260437}]


## Tres pasos principales
1. El texto se procesa a un formato que el modelo pueda interpretar.
2. Los inputs preprocesados se pasan al modelo.
3. Las predicciones del modelo se post procesan para que sean entendibles.

## Pipelines disponibles
- feature-extraction (get the vector representation of a text)
- fill-mask
- ner (named entity recognition): Tarea en la que el modelo debe clasificar qué partes del texto corresponden a entidades como 
- question-answering
- sentiment-analysis (clasificar en emociones el texto)
- summarization
- text-generation
- translation
- zero-shot-classification

## Ejemplos (no necesario leer)
### Zero-shot classification
